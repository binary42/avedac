/*!@file pmbarivision/src/Pmbarivision.C a program to automate detection of events 
  ...
  This program uses The iLab Neuromorphic Vision C++ Toolkit - Copyright (C) 2000-2002
  by the University of Southern California (USC) and the iLab at USC. 
  See http://iLab.usc.edu for information about this project. 
*/
// Primary maintainer for this file: Danelle Cline <dcline@mbari.org>
// $Id: Pmbarivision.C,v 1.2 2007/09/26 23:06:54 dcline Exp $
...
extern "C" {
  ...
  Stage *createStage(MPI_Comm master, Stages::stageID id, int argc, const char **argv,  ModelManager &manager)
  {
    ...
    nub::soft_ref<MbariResultViewer> rv(new MbariResultViewer(manager, ofs, exe.substr(0,found)));
