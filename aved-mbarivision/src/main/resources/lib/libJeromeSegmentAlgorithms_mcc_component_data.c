...
extern "C" {
#endif
const unsigned char __MCC_libJeromeSegmentAlgorithms_session_key[] = {
...
const unsigned char __MCC_libJeromeSegmentAlgorithms_public_key[] = {
...
static const char * MCC_libJeromeSegmentAlgorithms_matlabpath_data[] = 
    { "libJeromeSegmentAlgorithms/", "toolbox/compiler/deploy/",
      "graphCut/", "$TOOLBOXMATLABDIR/general/",
      ...
      "toolbox/local/", "toolbox/compiler/", "toolbox/images/images/",
      "toolbox/images/imuitools/", "toolbox/images/iptutils/",
      "toolbox/shared/imageslib/", "toolbox/images/medformats/" };

static const char * MCC_libJeromeSegmentAlgorithms_classpath_data[] = 
    { "java/jar/toolbox/images.jar" };

static const char * MCC_libJeromeSegmentAlgorithms_libpath_data[] = 
    { "" };

static const char * MCC_libJeromeSegmentAlgorithms_app_opts_data[] = 
    { "" };

static const char * MCC_libJeromeSegmentAlgorithms_run_opts_data[] = 
    { "" };

static const char * MCC_libJeromeSegmentAlgorithms_warning_state_data[] = 
    { "" };


mclComponentData __MCC_libJeromeSegmentAlgorithms_component_data = { 

    /* Public key data */
    __MCC_libJeromeSegmentAlgorithms_public_key,

    /* Component name */
    "libJeromeSegmentAlgorithms",

    /* Component Root */
    "",

    /* Application key data */
    __MCC_libJeromeSegmentAlgorithms_session_key,

    /* Component's MATLAB Path */
    MCC_libJeromeSegmentAlgorithms_matlabpath_data,

    /* Number of directories in the MATLAB Path */
    39,

    /* Component's Java class path */
    MCC_libJeromeSegmentAlgorithms_classpath_data,
    /* Number of directories in the Java class path */
    1,

    /* Component's load library path (for extra shared libraries) */
    MCC_libJeromeSegmentAlgorithms_libpath_data,
    /* Number of directories in the load library path */
    0,

    /* MCR instance-specific runtime options */
    MCC_libJeromeSegmentAlgorithms_app_opts_data,
    /* Number of MCR instance-specific runtime options */
    0,

    /* MCR global runtime options */
    MCC_libJeromeSegmentAlgorithms_run_opts_data,
    /* Number of MCR global runtime options */
    0,
    
    /* Component preferences directory */
    "libJeromeSegmentAlgorithms_A988A7442891AE282900B0763A809EF4",

    /* MCR warning status data */
    MCC_libJeromeSegmentAlgorithms_warning_state_data,
