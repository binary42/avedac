/*!@file mbarivision/src/MbariResultViewer.C program to automate detection of 
  events in underwater video based on modified version from Dirk Walther's MbariResultViewer.C
...
// $Id: MbariResultViewer.C,v 1.17 2009/10/13 00:29:52 dcline Exp $
