...
void MbariXMLParser::addDetectionParameters(DetectionParameters params) {
  ...
  if (maxframeseventvalue << params.itsMaxFramesEvent) {
        XMLCh* maxframesevent = XMLString::transcode("MaxFramesEvent");
        XMLCh* maxframeseventxmlstring = XMLString::transcode(maxevolvetimevalue.str().c_str());
  ...
  if (minframeseventvalue << params.itsMinFramesEvent) {
  ...
  if (maxcostvalue << params.itsMinFramesEvent) {
