...
// $Id: Geometry2D.C,v 1.3 2009/04/16 23:58:06 dcline Exp $
//
...
// ######################################################################
Vector2D::Vector2D(const Point2D<float>& point)
...
// ######################################################################
LineSegment2D::LineSegment2D(const Point2D<float>& p1,
...
// ######################################################################
void LineSegment2D::reset(const Point2D<float>& p1,
                          const Point2D<float>& p2)
{
  itsPoint1 = p1;
  itsPoint2 = p2;
...
// ######################################################################
Point2D<float> LineSegment2D::point1() const
{
  ASSERT(isValid());
  return (itsPoint1);
}
...
// ######################################################################
Point2D<float> LineSegment2D::point2() const
{
  ASSERT(isValid());
  return (itsPoint2);
}
...
bool LineSegment2D::intersects(LineSegment2D &line, double &xcoord, double &ycoord) const
{
  ...
  if (!isFinite(x) || !isFinite(y) ||
      distance(Point2D<float>(x, y)) > 0.000010 ||
      line.distance(Point2D<float>(x, y)) > 0.000010  ) {
...
double LineSegment2D::distance(Point2D<float> point) const {
  Vector2D A(point1());
  Vector2D B(point2());
