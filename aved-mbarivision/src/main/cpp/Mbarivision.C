/*!@file mbarivision/src/Mbarivision.C program to automate detection of 
  events in underwater video based on modified version from Dirk Walther's test-mbari.C
  file in The iLab Neuromorphic Vision C++ Toolkit - Copyright (C) 2000-2002
  by the University of Southern California (USC) and the iLab at USC. 
  See http://iLab.usc.edu for information about this project. 
 */
//
// Primary maintainer for this file: Danelle Cline <dcline@mbari.org>
// $Id: Mbarivision.C,v 1.22 2009/10/12 22:56:52 dcline Exp $
...
int main(const int argc, const char** argv) {
    ...
    ModelManager manager("MBARI Automated Video Event Detection Program");
