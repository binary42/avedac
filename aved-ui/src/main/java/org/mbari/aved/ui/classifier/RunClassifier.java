...
public class RunClassifier {
    ...
    public RunClassifier(ClassifierModel model, EventListModel eventListModel, SummaryModel summaryModel) {
        controller = new RunClassifierController(model, eventListModel, summaryModel);
    }
