...
public class PlayerView extends JFrameView {
    ...
    public PlayerView(EventObjectContainer event, ApplicationModel model, PlayerController controller) {
        ...
        try {
            ...
            // TODO Do something with exception like propogate up
            e.printStackTrace();
        }
    }
    ...
    public void updateLabels() {
        ...
        getForm().getLabel(ID_EVENT_DURATION_LABEL).setText(String.valueOf(event.getFrameDuration()));
