 ...
 * @author dcline
 */
public class ModalYesNoNeverDialog extends JDialog implements ActionListener {
    private static final long serialVersionUID = 1L;
    private boolean           isAnswered       = false,
                              isYes            = false,
                              isNever          = false;
    private JCheckBox         isNeverCheckBox;

    public ModalYesNoNeverDialog(JFrame frame, String question) {
        super(frame, true /* modal */);

        final FormPanel formPanel = new FormPanel("org/mbari/aved/ui/forms/MessageYesNoNever.xml");
        ...
        isNeverCheckBox = formPanel.getCheckBox("donotdisplay");
        pack();
        setResizable(false);
    ...
    synchronized public void actionPerformed(ActionEvent e) {
        ...
        isYes   = actionCommand.equals("Yes");
        isNever = isNeverCheckBox.isSelected();
