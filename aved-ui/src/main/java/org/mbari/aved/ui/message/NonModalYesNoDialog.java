/*
 * @(#)NonModalYesNoDialog.java   10/03/17
 * 
...
public class NonModalYesNoDialog extends JDialog implements ActionListener {
    ...
    public NonModalYesNoDialog(JFrame frame, String question) {
